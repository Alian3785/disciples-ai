...
// Призываем воздушного элементаля на пустое место, или на место мертвого чувака
        ...
        if (attackedCreature.health <= 0 && attackedCreature.team === attackerCreature.team) {
            if (attackerCreature.team === "red") {
                ...
                else if (deliveredvalue2[8][0] > 0 && deliveredvalue2[8][14] === 0 && deliveredvalue2[11][0] <= 0)
                {
                    alert("Призываем юнита в правый нижний угол");
                    summonundeadlowright();
                    }
            ...
            if (deliveredvalue2[7][0] === 0 && deliveredvalue2[10][0] === 0) {
                ...
                notnextturtn = 1;}
            else if (deliveredvalue2[7][0] > 0 && deliveredvalue2[7][14] === 0 && deliveredvalue2[10][0] <= 0) {
                alert("Призываем юнита в центральный нижний угол");
                summonundeadlowcenter();
            }
                ...
                if (deliveredvalue2[6][0] === 0 && deliveredvalue2[9][0] === 0) {
                    ...
                    notnextturtn = 1;}
                else if (deliveredvalue2[6][0] > 0 && deliveredvalue2[6][14] === 0 && deliveredvalue2[9][0] <= 0) {
                    alert("Призываем юнита в левый нижний угол");
                    summonundeadlowleft();
                }
...
// юнит уже походил, нужно для инициативы
    ...
    function summondragoncenter () {
        ...
        randomdragon = Math.round(Math.random());
        if (randomdragon === 0) {
            deliveredvalue2[7] = [/*здоровье*/375, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/55, /*урон2*/0, /*инит*/35, /*тип*/"mage", /*кто*/"Дракон смерти", /*дваудара*/0, /*размер*/1, /*смерть*/3, /*аним*/126];
        } else {
            deliveredvalue2[7] = [/*здоровье*/525, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/75, /*урон2*/0, /*инит*/35, /*тип*/"mage", /*кто*/"Драколич", /*дваудара*/0, /*размер*/1, /*смерть*/3, /*аним*/128];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] =  {
            damage: deliveredvalue2[7][8],
    ...
    function summondragonleft () {
        ...
        randomdragon = Math.round(Math.random());
        if (randomdragon === 0) {
            deliveredvalue2[6] = [/*здоровье*/375, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/55, /*урон2*/0, /*инит*/35, /*тип*/"mage", /*кто*/"Дракон смерти", /*дваудара*/0, /*размер*/1, /*смерть*/3, /*аним*/126];
        } else {
            deliveredvalue2[6] = [/*здоровье*/525, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/75, /*урон2*/0, /*инит*/35, /*тип*/"mage", /*кто*/"Драколич", /*дваудара*/0, /*размер*/1, /*смерть*/3, /*аним*/128];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] =  {
            damage: deliveredvalue2[6][8],
    ...
    function summonundeadhighleft () {
        ...
        if (randomdragon === 1) {
            deliveredvalue2[6] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[6] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[6] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[6] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[6] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] =  {
            damage: deliveredvalue2[6][8],
    ...
    function summonundeadcenter () {
        ...
        randomdragon = randomInteger(1, 5);
        if (randomdragon === 1) {
            deliveredvalue2[7] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[7] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[7] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[7] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[7] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] =  {
            damage: deliveredvalue2[7][8],
    ...
    function summonundeadright () {
        ...
        randomdragon = randomInteger(1, 5);
        if (randomdragon === 1) {
            deliveredvalue2[8] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[8] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[8] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[8] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[8] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] = {
            damage: deliveredvalue2[8][8],
    ...
    function summonundeadlowcenter () {
        ...
        randomdragon = randomInteger(1, 5);
        if (randomdragon === 1) {
            deliveredvalue2[10] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[10] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[10] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[10] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[10] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] = {
            damage: deliveredvalue2[10][8],
            ...
            glowred: function () {
                if (this.size === 0) {
                    ...
                    document.getElementById("DIVmybig13").classList.add("el");
                }
                setTimeout(this.removerednow, 1000);
            },
            removered: function () {
    ...
    function summonundeadlowleft () {
        ...
        randomdragon = randomInteger(1, 5);
        if (randomdragon === 1) {
            deliveredvalue2[9] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[9] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[9] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[9] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[9] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] = {
            damage: deliveredvalue2[9][8],
            ...
            dienow: function () {
                if (this.size === 0) {
                    ...
                    document.getElementById("DIVm12").classList.remove("skeletor");
                    newRect3.setAttribute("y", "150");
                    deliveredvalue2[9][0] = 0;
                    animation10_stay.destroy();
                    animation10_hurt.destroy();
                    animation10_attack.destroy();
                    animation10_weapon.destroy();
                    animation10_death.destroy();
                } else {
                    document.getElementById("DIVmybigdead13").classList.add("bonespicture2");
                    document.getElementById("DIVmybigdead13").classList.remove("skeletor2");
                    newRect3.setAttribute("y", "150");
    ...
    function summonundeadlowright () {
        ...
        randomdragon = randomInteger(1, 5);
        if (randomdragon === 1) {
            deliveredvalue2[11] = [/*здоровье*/185, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/50, /*урон2*/0, /*инит*/40, /*тип*/"vampire", /*кто*/"Вампир", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/115];
        } else if (randomdragon === 2)
        {
            deliveredvalue2[11] = [/*здоровье*/140, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/70, /*урон2*/0, /*инит*/40, /*тип*/"mage", /*кто*/"Лич", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/116];
        }
        else if (randomdragon === 3)
        {
            deliveredvalue2[11] = [/*здоровье*/150, /*броня*/0, /*иммунитет*/["weapon", "death"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"", /*точн*/0.8, /*точн2*/0, /*урон*/60, /*урон2*/0, /*инит*/60, /*тип*/"archer", /*кто*/"Дух", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/114];
        }
        else if (randomdragon === 4)
        {
            deliveredvalue2[11] = [/*здоровье*/125, /*броня*/0, /*иммунитет*/["death", "weapon"],/*защита*/[], /*тип атаки1*/"death", /*тип атаки2*/"death", /*точн*/0.8, /*точн2*/0.5, /*урон*/100, /*урон2*/20, /*инит*/40, /*тип*/"assasin", /*кто*/"Смерть", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/117];
        }
        else if (randomdragon === 5)
        {
            deliveredvalue2[11] = [/*здоровье*/135, /*броня*/0, /*иммунитет*/["death"],/*защита*/[], /*тип атаки1*/"mind", /*тип атаки2*/"", /*точн*/0.5, /*точн2*/0, /*урон*/0, /*урон2*/0, /*инит*/20, /*тип*/"shadow", /*кто*/"Тень", /*дваудара*/0, /*размер*/0, /*смерть*/3, /*аним*/123];
        }
        console.log(deliveredvalue2);
        creatures[indextofind] = {
            damage: deliveredvalue2[11][8],
            ...
            dienow: function () {
                if (this.size === 0) {
                    ...
                    document.getElementById("DIVm4").classList.remove("skeletor");
                    newRect3.setAttribute("y", "150");
                    deliveredvalue2[11][0] = 0;
                    animation12_stay.destroy();
                    animation12_hurt.destroy();
                    animation12_attack.destroy();
                    animation12_weapon.destroy();
                    animation12_death.destroy();
                } else {
                    document.getElementById("DIVmybigdead13").classList.add("bonespicture2");
                    document.getElementById("DIVmybigdead13").classList.remove("skeletor2");
                    newRect3.setAttribute("y", "150");
